/**
 * @file optimize_v7.cpp
 * @author Worralop Srichainont
 * @brief Minimum Power Plant Coverage solution code with thread-level parallelism.
 * @version 8.0
 * @date 12 Apr 2026
 */
